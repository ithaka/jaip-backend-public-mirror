...
export const ANALYTICS_S3_PATH = `analytics/mvp`;
export const CUSTOM_CONTENT_S3_PATH = `jaip-collections`;
export const OFFLINE_INDICES = {
  content_mac: `offline_drive_downloads/with_content/JSTOR-Mac.zip`,
  content_windows: `offline_drive_downloads/with_content/JSTOR-Windows.zip`,
  content_chromebook: `offline_drive_downloads/with_content/JSTOR-Chromebook.zip`,
  no_content_windows: `offline_drive_downloads/without_content/JSTOR-Windows.zip`,
  no_content_chromebook: `offline_drive_downloads/without_content/JSTOR-Chromebook.zip`,
};
